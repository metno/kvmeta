...
connection = cx_Oracle.connect("kaxx", kaxx_pw, """(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=gfwzy228.adb.eu-frankfurt-1.oraclecloud.com))(connect_data=(service_name=g6d7a1747646f6d_dvh10adb_low.adb.oraclecloud.com))(security=(ssl_server_dn_match=no)))""")
