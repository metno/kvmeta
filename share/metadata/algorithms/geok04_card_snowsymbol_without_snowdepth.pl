...
#language : 1
#checkname: geok04_card_snowsymbol_without_snowdepth
#signature: obs;RR,SA,V4,V5,V6;;|meta;X_1;;


# Konsistenskontroll check Appendix 5
# Kode hentet fra "snowdepth_precip_weather.pl", subcheck 4 (geok)
...
# Ny versjon Bjørn Nordin 28.12.2005 - Geok splittet opp.
...
#  }
       ...
       # Check no. 72.4 Snow symbol without snow depth ---------------------
	if ($XSA[0] <= 0 && $XRR[0] > $X_1[0] && $dk eq "SNE" && $XSA_missing[0]==0) {
	  $flag = 4;
