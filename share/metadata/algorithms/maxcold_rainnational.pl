...
#checkname:	maxcold_rainnational
#signature: obs;TAX_12,V1,V2,V3;;
...
sub check {
#TAX_12 og minst en av V1/V2/V3 må foreligge:
    if ($TAX_12_missing[0]==0 && ($V1_missing[0]==0 || $V2_missing[0]==0 || $V3_missing[0]==0)) 
    {
	...
	if ($TAX_12[0] < 0.5 && ($V1[0] == 8 || $V2[0] == 8 || $V3[0] == 8 || $V1[0] == 3 || $V2[0] == 3 || $V3[0] == 3)) {
	...
	my @retvector;
	push(@retvector, "TAX_12_0_0_flag");
	push(@retvector, $TAX_12flag);
